...
export default function SkillDetail() {
	...
	return (
		<CenterCardLayout>
			<h1>
				{title} <span className="font-normal text-lg text-primary">{slug}</span>
			</h1>
			<RequirementList title="채용공고" dataList={requirements} />
			<Divider />
			<SkillList title="상위 역량" dataList={parents} />
			<SkillList title="하위 역량" dataList={children} />
			<Divider />
			...
			<Divider />
			<ResourceList title="학습 자료" dataList={resources} />
